...
export default function ForgotPage() {
  return (
    <div className="rounded-3xl bg-white p-6 shadow-[0_20px_50px_rgba(31,51,52,0.08)] sm:p-8">
      <h1 className="font-display text-3xl text-teal-dark">Redefinir senha</h1>
      <p className="mt-1 mb-6 text-sm text-muted">Enviamos um link para o e-mail cadastrado.</p>
      <ForgotForm />
